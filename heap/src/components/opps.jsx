  ...
  render() {
    ...
    return (
      <div className="wrapper">
        ...
        <div>
          {items.map((item) => (
            <div key={item.id} className="card card-compact w-30 bg-base-100 shadow-xl" style={{ filter: "drop-shadow(0px 0px 5px #555)", borderRadius: 10 }}>
              <figure>
                <img
        ...
        <div className="card card-compact w-30 bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <p>Volunteer opportunity</p>
            <div className="card-actions justify-end">
              <button className="btn btn-primary" onClick={(event) => this.volunteerSubmit(event, 'SICS')}>Volunteer Now</button>
            </div>
          </div>
        </div>
      </div>
